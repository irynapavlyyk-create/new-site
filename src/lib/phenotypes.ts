...
export const PHENOTYPES: Record<PhenotypeId, PhenotypeData> = {
  "wired-but-tired": {
    ...
    name: {
      en: "Wired but tired",
      cs: "На взводе, но в нуле",
    },
    subtitle: {
      en: "Cortisol stays high when it shouldn't. Body wants rest, mind won't allow it. Sleep feels light and unfinished.",
      cs: "Кортизол высокий когда не должен. Тело просит отдыха, ум не отпускает. Сон лёгкий и не восстанавливает.",
    },
    insights: [
      {
        kind: "morning",
        label: { en: "Wake feels alert", cs: "Утром в боевой готовности" },
        description: {
          en: "Cortisol spikes too early. You're up but not rested.",
          cs: "Кортизол выходит на пик слишком рано. Ты на ногах, но не отдохнул.",
        },
      },
      {
        kind: "afternoon",
        label: { en: "No real crash", cs: "Без реального спада" },
        description: {
          en: "Body keeps pushing. Underneath it you're exhausted.",
          cs: "Тело продолжает работать. Под этим — истощение.",
        },
      },
      {
        kind: "evening",
        label: { en: "Can't wind down", cs: "Не получается выключиться" },
        description: {
          en: "Mind races at bedtime. Body too wired for sleep.",
          cs: "Ум гонит мысли в постели. Тело слишком взвинчено для сна.",
        },
      },
    ],
  ...
  "crashed-circadian": {
    ...
    subtitle: {
      ...
      cs: "Тяжело проснуться. Тяжело уснуть. Твой ритм живёт в другом часовом поясе, чем твоя жизнь.",
    },
    insights: [
      {
        kind: "morning",
        label: { en: "Snooze cycles", cs: "Циклы будильника" },
        description: {
          en: "Cortisol curve fires hours late. Mornings feel impossible.",
          cs: "Кортизоловая кривая запаздывает на часы. Утро кажется невозможным.",
        },
      },
      {
        kind: "afternoon",
        label: { en: "Slow start, late peak", cs: "Медленный старт, поздний пик" },
        description: {
          en: "You finally feel awake when others wind down.",
          cs: "Ты только включаешься, когда все остальные сворачиваются.",
        },
      },
      {
        kind: "evening",
        label: { en: "Wide awake at midnight", cs: "Бодрый в полночь" },
        description: {
          en: "Your peak hits when you should be asleep.",
          cs: "Твой пик приходит, когда нужно спать.",
        },
      },
    ],
  ...
  "depleted-engine": {
    ...
    subtitle: {
      ...
      cs: "Базовая энергия низкая — весь день, каждый день. Кофе почти не действует. Восстановление занимает больше времени, чем раньше.",
    },
    insights: [
      {
        kind: "morning",
        label: { en: "Tired on waking", cs: "Уставший с пробуждения" },
        description: {
          en: "Sleep didn't recharge you. Energy starts low.",
          cs: "Сон не зарядил. Энергия начинается с минимума.",
        },
      },
      {
        kind: "afternoon",
        label: { en: "Flat all day", cs: "Ровно низко весь день" },
        description: {
          en: "No real peaks. Caffeine barely shifts the line.",
          cs: "Никаких пиков. Кофе почти не двигает линию.",
        },
      },
      {
        kind: "evening",
        label: { en: "Crash by 8pm", cs: "Падаешь к 8 вечера" },
        description: {
          en: "Reserves run out. Sleep comes from exhaustion, not rhythm.",
          cs: "Резервы кончаются. Сон приходит от усталости, не от ритма.",
        },
      },
    ],
    peakHours: { en: "—", cs: "—" },
    crashWindow: { en: "All day", cs: "Весь день" },
    secondWind: { en: "—", cs: "—" },
  ...
  "afternoon-crasher": {
    ...
    name: {
      en: "Adrenal Drift",
      cs: "Адреналовый дрейф",
    },
    subtitle: {
      en: "Mornings start slow. Cortisol peaks late. The 2 PM crash is steep but predictable—and the 8 PM second wind is real.",
      cs: "Утро начинается медленно. Кортизол выходит на пик поздно. Падение в 2 часа дня резкое, но предсказуемое — и второе дыхание в 8 вечера реально.",
    },
    insights: [
      {
        kind: "morning",
        label: { en: "Slow start", cs: "Медленный старт" },
        description: {
          en: "Cortisol peaks late. Don't force coffee before 9am.",
          cs: "Кортизол выходит на пик поздно. Не форсируй кофе до 9 утра.",
        },
      },
      {
        kind: "afternoon",
        label: { en: "Steep 2–4pm crash", cs: "Резкий спад в 2–4 дня" },
        description: {
          en: "Predictable drop. Plan light tasks here.",
          cs: "Падение предсказуемо. Планируй на этот час лёгкие задачи.",
        },
      },
      {
        kind: "evening",
        label: { en: "8pm second wind", cs: "Второе дыхание в 8 вечера" },
        description: {
          en: "Use it. But cut sharp at 10pm.",
          cs: "Используй его. Но обрывай ровно в 10 вечера.",
        },
      },
    ],
  ...
  "brain-fog-dominant": {
    ...
    subtitle: {
      ...
      cs: "Тело есть. Мозг — нет. Концентрация короткая, решения даются тяжело, слова не приходят быстро.",
    },
    insights: [
      {
        kind: "morning",
        label: {
          ...
          cs: "Тело есть, голова — нет",
        },
        description: {
          en: "Body wakes faster than mind. Words come slow.",
          cs: "Тело просыпается быстрее ума. Слова приходят медленно.",
        },
      },
      {
        kind: "afternoon",
        label: { en: "Foggy under stress", cs: "Туман под нагрузкой" },
        description: {
          en: "Concentration breaks under load. Decisions feel heavy.",
          cs: "Концентрация рушится под нагрузкой. Решения даются тяжело.",
        },
      },
      {
        kind: "evening",
        label: { en: "Clearer at night", cs: "Ночью яснее" },
        description: {
          en: "Cognition returns when pressure drops.",
          cs: "Когнитивные функции возвращаются, когда давление спадает.",
        },
      },
    ],
  ...
  "stress-burnout-transitioning": {
    ...
    subtitle: {
      ...
      cs: "Ещё функционируешь, но еле-еле. Стресс громче чем отдых. Мелочи требуют больше, чем должны.",
    },
    insights: [
      {
        kind: "morning",
        label: { en: "Dread before tasks", cs: "Тревога перед задачами" },
        description: {
          en: "Anticipation of effort feels louder than the effort itself.",
          cs: "Ожидание усилия громче самого усилия.",
        },
      },
      {
        kind: "afternoon",
        label: { en: "Stress amplifies", cs: "Стресс усиливается" },
        description: {
          en: "Small things take more than they should.",
          cs: "Мелочи требуют больше, чем должны.",
        },
      },
      {
        kind: "evening",
        label: { en: "Can't switch off", cs: "Не выключаешься" },
        description: {
          en: "Mind keeps working long after body wants rest.",
          cs: "Ум продолжает работать ещё долго после того, как тело хочет отдыха.",
        },
      },
    ],
