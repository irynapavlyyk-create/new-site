...
export const t = {
  ...
  auth: {
    ...
    name: { en: "Name (optional)", ru: "Имя (по желанию)" },
    forgotPassword: { en: "Forgot password?", ru: "Забыли пароль?" },
    orContinueWith: { en: "or continue with", ru: "или войти через" },
    signInWithGoogle: { en: "Sign in with Google", ru: "Войти через Google" },
    signUpWithGoogle: { en: "Sign up with Google", ru: "Зарегистрироваться через Google" },
    noAccount: { en: "Don't have an account?", ru: "Нет аккаунта?" },
    haveAccount: { en: "Already have an account?", ru: "Уже есть аккаунт?" },
    loginTitle: { en: "Welcome back", ru: "С возвращением" },
    loginSubtitle: {
      en: "Sign in to access your personal plan.",
      ru: "Войдите, чтобы открыть свой план.",
    },
    signupTitle: { en: "Create your account", ru: "Создай аккаунт" },
    signupSubtitle: {
      en: "Save your results and access your plan from any device.",
      ru: "Сохраняй результаты и открывай план с любого устройства.",
    },
    agreeToTerms: {
      en: "I agree to the",
      ru: "Я соглашаюсь с",
    ...
    invalidEmail: { en: "Please enter a valid email.", ru: "Введите корректный email." },
    checkEmailSignup: {
      en: "Check your email to confirm your account.",
      ru: "Проверьте почту — мы прислали ссылку для подтверждения аккаунта.",
    },
    forgotTitle: { en: "Reset your password", ru: "Сброс пароля" },
    forgotSubtitle: {
      en: "Enter your email and we'll send you a reset link.",
      ru: "Укажи email — пришлём ссылку для сброса пароля.",
    },
    sendResetLink: { en: "Send reset link", ru: "Отправить ссылку" },
    checkEmailReset: {
